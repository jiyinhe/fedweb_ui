...
# After this number of clicks, a give up button will show up
GiveUpThresh = 25
...
SECRET_KEY = '%v9g$na5dv%^!!pcqdf-a57ja=mr1c2^$=fzwzdgiex7gf&amp;)+0'
...
ROOT_URLCONF = 'fw_userstudy.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fw_userstudy.wsgi.application'
